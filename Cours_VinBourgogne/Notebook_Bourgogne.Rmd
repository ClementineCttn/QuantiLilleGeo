...
Comme prévu, les vignobles de grandes surfaces ont des prix en moyenne moins élevés ("ce qui est rare est cher"). Par contre, la qualité physique des vignobles est non-significative dans le modèle des prix à un niveau.
...
- La variance résiduelle du niveau commune est de vrn1 = `r round(vrn1,3)`.
...
Dans ce modèle vide à 2 niveaux, `r round(icc*100,1)`% de la variance est prise en charge par l'appartenance au niveau 2.
